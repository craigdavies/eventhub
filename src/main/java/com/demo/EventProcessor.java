...
public class EventProcessor implements IEventProcessor
{
    ...
    {
        System.out.println("Trailers: Partition " + context.getPartitionId() + " is opening");


        //Test code to open connection to MongoDb create collection and append json data extracted from eventhub events to the db.
        MongoClient mongoClient = new MongoClient("localhost", 27017);
        DB db = mongoClient.getDB("trailers");
        ...
        DBCollection dbCollection = db.getCollection("events");
    ...
    {
        System.out.println("Trailers: Partition " + context.getPartitionId() + " is closing for reason " + reason.toString());
    }
    ...
    {
        System.out.println("Trailers: Partition " + context.getPartitionId() + " onError: " + error.toString());
    }
    ...
    {
        System.out.println("Trailers: Partition " + context.getPartitionId() + " got event batch");
        int eventCount = 0;
        for (EventData data : events)
        {
            ...
            try
            {
                System.out.println("Trailers (" + context.getPartitionId() + "," + data.getSystemProperties().getOffset() + "," +
                ...
                {
                    System.out.println("Trailers: Partition " + context.getPartitionId() + " checkpointing at " +
        ...
        System.out.println("Trailers: Partition " + context.getPartitionId() + " batch size was " + eventCount + " for host " + context.getOwner());
    }
}
